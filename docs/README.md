...
3. `../evals/README.md` — the public proof suite for the safe-autonomy story
4. `kickoff.md` — greenfield workflow for generating initial `docs/*` + `specs/*`
5. `harness-readiness.md` — repo-local checklist for agent legibility, reproducibility, and failure handling
6. `pr-triage-2026-03-05.md` — current PR triage notes
