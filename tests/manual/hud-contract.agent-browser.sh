...
wait_for_visible "slots panel renders" '#slots-body'
wait_for_visible "director scene switch renders" '#scene-director'
...
wait_for_visible "broadcast frame toggle renders" '#presentation-toggle'
click_selector "broadcast frame toggle responds" '#presentation-toggle'
wait_for_text_contains "broadcast frame toggle flips label" '#presentation-toggle' 'Exit broadcast frame'
wait_for_visible "director recap rail renders" '#director-recap'
wait_for_text_contains "director proof shelf renders" '#director-showcase' 'What shipped'
wait_for_text_contains "director share card renders" '#director-showcase' 'Copy episode summary'
